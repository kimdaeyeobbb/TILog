...
public class StudentController {
    ...
    public void printScore(String name){
        ...
        if( student != null){
            System.out.println(student.getName() +"학생의 점수는 "+ student.getScore()+ "점 입니다");
        } else {
            System.out.println(student.getName() +" 학생은 존재하지 않습니다");
        }
    }
    ...
    public void update(String name, int score){
        ...
        if(result){
            System.out.println(student.getName() +" 학생의 점수를 변경했습니다");
        } else {
            System.out.println(student.getName() +" 학생은 존재하지 않습니다");
        }
    }
